...
| [`@everyx/pi-read-doc`](./packages/pi-read-doc/README.zh.md) | 增强 read——Office 文档（Word/Excel/PowerPoint/PDF）经 anydoc 转 Markdown，扫描页 OCR（Firecrawl 或本地 rapidocr，由你配置）。 |
