...
| [`@everyx/pi-read-doc`](./packages/pi-read-doc/README.md) | Enhanced read — office docs (Word/Excel/PowerPoint/PDF) via anydoc → markdown, OCR for scanned pages (Firecrawl or local rapidocr, your choice). |
